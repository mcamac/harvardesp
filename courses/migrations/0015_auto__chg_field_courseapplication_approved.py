...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseApplication.approved'
        db.alter_column(u'courses_courseapplication', 'approved', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'CourseApplication.approved'
        db.alter_column(u'courses_courseapplication', 'approved', self.gf('django.db.models.fields.BooleanField')())
