...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CourseUpload'
        db.create_table(u'courses_courseupload', (
        ...
        db.send_create_signal(u'courses', ['CourseUpload'])


    def backwards(self, orm):
        # Deleting model 'CourseUpload'
        db.delete_table(u'courses_courseupload')
