...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.preferences'
        db.add_column(u'courses_student', 'preferences',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.preferences'
        db.delete_column(u'courses_student', 'preferences')
    ...
    models = {
        ...
        u'courses.course': {
            ...
            'timeslot': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'confirmed_courses'", 'null': 'True', 'to': u"orm['courses.Timeslot']"}),
        ...
        u'courses.student': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'needs_aid': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'preferences': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
