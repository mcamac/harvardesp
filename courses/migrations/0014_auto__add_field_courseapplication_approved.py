...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseApplication.approved'
        db.add_column(u'courses_courseapplication', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseApplication.approved'
        db.delete_column(u'courses_courseapplication', 'approved')
