...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.timeslot'
        db.add_column(u'courses_course', 'timeslot',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='confirmed_courses', null=True, to=orm['courses.Timeslot']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.timeslot'
        db.delete_column(u'courses_course', 'timeslot_id')
    ...
    models = {
        ...
        u'courses.course': {
            ...
            'timeslot': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'confirmed_courses'", 'null': 'True', 'to': u"orm['courses.Timeslot']"}),
